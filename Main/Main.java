...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        Bank Bank2 = new Bank(2,"BDa","123",10000.0,10000.0,1000.0,100.0);
        BankLauncher.addBank(Bank1);
        BankLauncher.addBank(Bank2);
        CreditAccount cred = new CreditAccount(Bank1,"1111", "Hitler","Adolf","hitler@gmail.com","12345");
        SavingsAccount save = new SavingsAccount(Bank1, "1112", "Laden", "Bin", "laden@gmail.com","12345", 1000.00);
        CreditAccount cred2 = new CreditAccount(Bank1,"1113", "Hitler","Adolf","hitler@gmail.com","12345");
        SavingsAccount save2 = new SavingsAccount(Bank1, "1114", "Laden", "Bin", "laden@gmail.com","12345", 1000.00);
        BankLauncher.bankLogin(Bank1.getName());
        BankLauncher.getLoggedBank().addNewAccount(cred);
        BankLauncher.getLoggedBank().addNewAccount(save);
        BankLauncher.logoutBank();
        BankLauncher.bankLogin(Bank2.getName());
        BankLauncher.getLoggedBank().addNewAccount(cred2);
        BankLauncher.getLoggedBank().addNewAccount(save2);
        BankLauncher.logoutBank();
                    ...
                    if(getOption()==1)
                    {
                        ...
                        if(BankLauncher.bankSize()!=0)
                        {
                            ...
                            if(BankLauncher.getLoggedBank()!=null) {
                                if (BankLauncher.getLoggedBank().getName().equals(bankName)) {
